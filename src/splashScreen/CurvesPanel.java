    ...
    /**
     * A panel that displays animated curves.
     *
     * This panel displays animated curves using Java's Graphics2D API.
     * The curves are drawn with a gradient fill that changes over time, creating a dynamic effect.
     *
     */
    ...
    public class CurvesPanel extends GradientPanel {
         ...
         *
         * This method starts the timer that triggers the animation.
         *
         */
         ...
         * Stops the animation.
         *
         * This method stops the timer that triggers the animation.
         *
         */
        ...
        /**
         * Constructs a CurvesPanel with default colors and starts the animation.
         */
         ...
         *
         * This method is responsible for painting the curves on the panel.
         *
